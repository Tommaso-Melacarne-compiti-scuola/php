...
$dbnameDB = "classicmodels"; // Qui bisogna cambiare con il nome del database presente su phpMyAdmin
...
$conn->set_charset("utf8"); // Imposto la codifica dei caratteri a UTF-8
